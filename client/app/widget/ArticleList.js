define([
    ...
    "dgrid/OnDemandList",
], function(declare, lang, Deferred, on, topic, query, domConstruct, domAttr, domClass, dateLocale, mustache, articleRowTemplate, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, OnDemandList) {

    var rowTemplate = mustache.compile(articleRowTemplate);

    return declare("app.widget.ArticleList", [ _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin ], {
